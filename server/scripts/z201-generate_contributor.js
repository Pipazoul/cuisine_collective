...
module.exports = {
  generate: function(app) {
    ...
    const contributor = [{
      ...
      'description': 'Les bénévoles des petits frères de pauvres peuvent vous accompagner dans les ateliers cuisine ou les repas collectifs près de chez vous. De porte à porte, dans les transports en commun, ou durant tout l\'atelier, nous conviendrons ensemble du format qui vous convient le mieux.',
      'name': 'Marie DUPONT',
